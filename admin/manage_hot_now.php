      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Manage Hot Now Products</h1>
          </div>
          ...
          <!-- Content Row -->
            <div class="row">
              ...
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">All Hot Now Products</h6>
              </div>
              <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Delete From Hot Now </h5>
          <button type="button" class="close" data-dismiss="modal" onclick="$('#modal1').modal('hide')" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          Are you sure you want to delete this product from Hot Now?
          <form id="delete_hot_now_form" method="post">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="delete_hot_now_btn" class="btn btn-danger">Delete</button>
        </div>
      </div>
    </div>
  </div>
